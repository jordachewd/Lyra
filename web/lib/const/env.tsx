...
export const isStaging = nodeEnv === 'production' && siteEnv === 'staging'
export const isProduction = nodeEnv === 'production' && siteEnv === 'production'
...
export const projectId = projId ?? 'fghdl4e4'

const projData = process.env.NEXT_PUBLIC_SANITY_DATASET
export const dataset = projData ?? 'staging'
